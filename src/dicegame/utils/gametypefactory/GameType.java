...
public interface GameType {
    ...
    int CUSTOM_GAME_ROUNDS = GameUtils.getCountFromProp(CommonConstants.ROUND_COUNT_STR);

    int SHORT_GAME_PLAYER_COUNT = 8;
    int LONG_GAME_PLAYER_COUNT = 20;
    int CUSTOM_GAME_PLAYER_COUNT = GameUtils.getCountFromProp(CommonConstants.PLAYER_COUNT_STR);
